...
const Quaternion Quaternion::Z_ROT_090 = Quaternion(3.1415926535/2, Vector(0, 0, 1));
const Quaternion Quaternion::Z_ROT_270 = Quaternion(-3.1415926535/2, Vector(0, 0, 1));
